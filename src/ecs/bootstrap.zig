...
pub fn spriteCreate(reg: *ecs.Registry, x:f32, y:f32, depth:f32, texturePath: []const u8, originX: f32, originY: f32) ecs.Entity {
...
/// Consider getting and editing the sprite component afterwards if you need a source rect.
pub fn sprite(reg: *ecs.Registry, ent: ecs.Entity, x:f32, y:f32, depth:f32, texturePath: []const u8, originX: f32, originY: f32) void {
